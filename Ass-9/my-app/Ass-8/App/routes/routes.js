...
//Create User
    app.post('/user/create',bodyParser.json(), function(req, res) {
        ...
        if( !email.trim().match(regexForEmail)){
            ...
            Sample.findOne({email: email}).then(function(err, user){
                if(err) {
                  console.log(err);
                }
                var message;
...
//delete users
    app.delete('/user/delete',function(req,res){
        ...
        Sample.findOneAndDelete({email:emailDelete}).then(function(doc){
    ...
    app.post('/user/login',function(req,res){
        ...
        Sample.findOne({email:email}).then(function( doc){
